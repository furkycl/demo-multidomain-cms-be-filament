...
class BlocksRelationManager extends RelationManager
{
    ...
    private static function typeOptions(): array
    {
        $labels = [
            ...
            'rich_text' => 'Rich Text', 'course_grid' => 'Course Grid',
            'accommodation_grid' => 'Accommodation Grid', 'destinations_grid' => 'Destinations Grid',
            'city_highlights' => 'City Highlights', 'article_list' => 'Article List (blog)',
            'header' => 'Header (basit)', 'footer' => 'Footer (basit)',
            'footer_mega' => 'Footer Mega', 'trust_bar' => 'Trust Bar',
    ...
    {
        return $form->schema([
            Forms\Components\Select::make('type')->required()->live()->searchable()
        ...
        return match ($type) {
            'hero_video' => [
                Forms\Components\TextInput::make('youtube_url')->required()
                    ->placeholder('https://www.youtube.com/watch?v=Zla917VnYNY')
                    ->helperText('YouTube link\'i. Otomatik autoplay+mute+loop ile arkaplan oynatılır.'),
                ...
                Forms\Components\Repeater::make('stats')
                    ->label('İstatistikler (4 kutu önerilir)')
                    ->schema([
                        Forms\Components\TextInput::make('value')->required()->placeholder('80+'),
                        Forms\Components\TextInput::make('label')->required()->placeholder('Yıllık deneyim'),
            ...
            'destinations_grid' => [
                ...
                Forms\Components\Repeater::make('items')->label('Destinations')->schema([
                    ...
                    Forms\Components\TextInput::make('youtube_url')
                        ...
                        ->helperText('Hover\'da oynayacak video (opsiyonel)'),
                  ...
                  ->itemLabel(fn ($s) => isset($s['city']) ? $s['city'].' — '.($s['country'] ?? '') : null),
            ],
            'course_grid' => [
                ...
                Forms\Components\Repeater::make('items')->schema([
                    ...
                    Forms\Components\Select::make('level')->options([
                        'a1'=>'A1','a2'=>'A2','b1'=>'B1','b2'=>'B2','c1'=>'C1','c2'=>'C2','mixed'=>'Tüm seviyeler',
                    ]),
            ...
            'header' => [
                ...
                Forms\Components\TextInput::make('logo_url')->url()
                    ->helperText('Header logosu — değiştirildiğinde tüm sayfalarda otomatik uygular.'),
                Forms\Components\TextInput::make('operated_by_text')->placeholder('Operated by')
                    ->helperText('Üst gradient bardaki "Operated by" metni'),
